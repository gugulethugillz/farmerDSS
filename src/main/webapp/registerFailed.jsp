    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <h3 class="text-uppercase">Response  !</h3>
                <p class="text-muted m-t-30 m-b-30">Registration Failed</p>
                <a href="register.jsp" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Ooops Try Again?</a> </div>
