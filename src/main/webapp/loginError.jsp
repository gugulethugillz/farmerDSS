    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                <h1>404</h1>
                <h3 class="text-uppercase">ACCOUNT DOES NOT EXIST!</h3>
                <p class="text-muted m-t-30 m-b-30">Please kindly create an account to login</p>
                <a href="register.jsp" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Click here to register</a> </div>
