...
<body class="fix-header card-no-border">
    ...
    <section id="wrapper" class="error-page">
        <div class= "w3-container error-box center" style="float: center"> 
                ...
                <p class="m-t-30 m-b-30">Maize adapts well to different soil types with a pH range of 5.0 -7.0. High yields are obtained from maize planted on deep, fine-structured, well-aerated,  well-drained loamy soils that are rich in organic matter. Shallow sandy soils should be avoided whenever possible as they are more affected by drought and reduce response to fertilizer application.It is advisable to try crops such as potatoes, beans, tomatoes, lettuce.</p>
