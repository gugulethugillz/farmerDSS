...
<%@page import="student.ac.zw.farmerdds.model.Queries" %>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Farming Inquiries</h3>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                   ...
                   <div class="col-12">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                             ...
                                             <c:forEach  items="${qq}" var="qq" >   
                                                 
                                            <tr>
                                                
                                                
                                                <td><c:out value="${qq.id}" /></td>
                                               <td><c:out value="${qq.question}" /></td>
                                                <td><c:out value="${qq.response}" /></td>
                                                 <td> 
                                                <a href="${pageContext.request.contextPath}/editQ?id=<c:out value='${qq.id}'/>">Respond</a>                  
                       ...
                       <div><a href="question.jsp" button class="buttonQ">Post Question</a>
