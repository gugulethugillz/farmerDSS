            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Post Question</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/createCrop">Home</a></li>
                            <li class="breadcrumb-item active">Post Question</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                   <div class="col-md-9">
                        <div class="card card-body">
                            ...
                            <form action="${pageContext.request.contextPath}/createQ" method="post">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-6 text-right control-label col-form-label">Enter Question</label>
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="offset-sm-3 col-sm-9">
                                        <button type="submit" class="btn btn-info waves-effect waves-light m-t-10">Post Question</button>
                                    </div>
                                </div>
