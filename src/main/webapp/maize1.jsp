...
<body class="fix-header card-no-border">
    ...
    <section id="wrapper" class="error-page">
        <div class= "w3-container error-box center" style="float: center"> 
                ...
                <p class="m-t-30 m-b-30">The pH is too low for growing maize and this can be fixed by liming. Use of appropriate liming agents (dolomite & calcitic lime) is recommended as this enhances Fertiliser Use Efficiency (FUE).</p>
