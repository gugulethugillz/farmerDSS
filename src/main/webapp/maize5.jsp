...
<body class="fix-header card-no-border">
    ...
    <section id="wrapper" class="error-page">
       <div class= "w3-container error-box center" style="float: center"> 
                ...
                <p class="m-t-30 m-b-30">The soil is too alkaline, you can lower your soil's pH or make it more acidic by using several products. These include sphagnum peat, elemental sulfur, aluminum sulfate, iron sulfate, acidifying nitrogen, and organic mulches. The moisture level is also too low, you should irrigate at this point.</p>
