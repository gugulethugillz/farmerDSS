                ...
                <div class="row">
                   <div class="col-md-9">
                        <div class="card card-body">
                            ...
                            <form action="${pageContext.request.contextPath}/editA" method="post">
                                <div class="form-group row">
                                    <label class="col-sm-3 text-right control-label col-form-label">Enter Question</label>
                                  
                                    <input type="text" name="question" class="form-control" <c:out value='${qq.question}' />
                                </div>
                               <div class="form-group row">
                                    <label  class="col-sm-3 text-right control-label col-form-label">Enter Response</label>
                                   <input type="hidden" name="id" class="form-control" <c:out value='${qq.id}'/>
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="offset-sm-3 col-sm-9">
                                        <button type="submit" class="btn btn-info waves-effect waves-light m-t-10">Respond</button>
                                    </div>
                                </div>
