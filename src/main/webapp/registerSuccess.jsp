    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                <h1>200</h1>
                <h3 class="text-uppercase">Response OK !</h3>
                <p class="text-muted m-t-30 m-b-30">Registration Successful</p>
                <a href="login.jsp" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Proceed to Log-In</a> </div>
