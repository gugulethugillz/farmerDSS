...
<body class="fix-header card-no-border">
    ...
    <section id="wrapper" class="error-page">
        <div class= "w3-container error-box center" style="float: center"> 
                ...
                <p class="m-t-30 m-b-30">Maize does not perform well in waterlogged soils, therefore, all sites prone to water-logging should be avoided. If such fields cannot be avoided then drain any areas where water ponds by digging channels to direct water away from the field. Proper drainage allows for early cultivation, better weed control and reduces the likelihood of nutrient leaching. The soil is too alkaline, you can lower your soil's pH or make it more acidic by using several products. These include sphagnum peat, elemental sulfur, aluminum sulfate, iron sulfate, acidifying nitrogen, and organic mulches.</p>
